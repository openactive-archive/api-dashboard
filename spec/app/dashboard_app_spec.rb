...
describe DashboardApp do
  ...
  it "returns a json file with appropriate metadata" do
    ...
    expect(result["meta"].keys).to include("last-updated", "licence", "attribution-text", "attribution-url")
  ...
  it "returns a dataset summary" do
    summary = DatasetSummary.new('activenewham/opendata')
    summary.update
    get "/summary/activenewham/opendata"
    expect(last_response.body).to include("<td>body attack</td>")
    expect(last_response.body).to include("<p>This summary was generated by sampling #{summary.samples}")
    expect(last_response.body).to include("<p>This summary was last updated: #{summary.last_updated.httpdate}</p>")
  end
