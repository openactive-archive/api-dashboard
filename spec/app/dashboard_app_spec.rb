...
describe DashboardApp do
  ...
  it "returns a dataset summary" do
    ...
    samples = Redis.current.hget('activenewham/opendata', "activity_samples").to_i
    get "/summary/activenewham/opendata"
    expect(last_response.body).to include("<td>body attack</td>")
    expect(last_response.body).to include("<p>Summary generated by sampling #{samples} opportunities since 2017.</p>")
  end
